    ...
    <div class="min-h-full flex flex-col justify-center py-8 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Or
                {{ ' ' }}
                <Link href="/registrationpage" class="font-medium text-indigo-600 hover:text-indigo-500"> register a new account </Link>
            </p>
        </div>
                ...
                <form class="space-y-6" @submit.prevent="submit">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input id="remember-me" v-model="form.remember" name="remember-me" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
...
export default {
    ...
    setup(){
        ...
        function submit() {
            Inertia.post('/login/validate', form)
        }
